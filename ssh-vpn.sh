...
# install
apt-get --reinstall --fix-missing install -y bzip2 gzip coreutils wget neofetch screen rsyslog iftop htop net-tools zip unzip wget net-tools curl nano sed screen gnupg gnupg1 bc apt-transport-https build-essential dirmngr libxml-parser-perl python git lsof
#echo "clear" >> .profile
